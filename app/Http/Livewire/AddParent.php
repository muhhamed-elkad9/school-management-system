...
class AddParent extends Component
{
    ...
    public function submitForm()
    {
        ...
        $this->successMessage = __('livewire/livewire.success');
        $this->clearForm();
        $this->currentStep = 1;
    }
    ...
    public function submitForm_edit()
    {
        ...
        if ($this->Parent_id) {
            ...
            return redirect()->to('/add_parent')->with([$this->successMessage => __('livewire/livewire.edit')]);
        }
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/add_parent')->with([$this->successMessage => __('livewire/livewire.delete')]);
    }
