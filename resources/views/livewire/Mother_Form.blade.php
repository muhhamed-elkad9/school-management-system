...
<div class="col-xs-12">
    <div class="col-md-12">
        ...
        <div class="form-row mb-4">
            <div class="col">
                <label for="title">{{ __('livewire/livewire.Name_Mother') }}</label>
            ...
            <div class="col">
                <label for="title">{{ __('livewire/livewire.Name_Mother_en') }}</label>
        ...
        <div class="form-row mb-4">
            <div class="col-md-3">
                <label for="title">{{ __('livewire/livewire.Job_Mother') }}</label>
            ...
            <div class="col-md-3">
                <label for="title">{{ __('livewire/livewire.Job_Mother_en') }}</label>
            ...
            <div class="col">
                <label for="title">{{ __('livewire/livewire.National_ID_Mother') }}</label>
            ...
            <div class="col">
                <label for="title">{{ __('livewire/livewire.Passport_ID_Mother') }}</label>
            ...
            <div class="col">
                <label for="title">{{ __('livewire/livewire.Phone_Mother') }}</label>
        ...
        <div class="form-group">
            <label for="exampleFormControlTextarea1">{{ __('livewire/livewire.Address_Mother') }}</label>
        ...
        @else
            <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="button"
                wire:click="secondStepSubmit">{{ __('livewire/livewire.Next') }}</button>
        @endif
