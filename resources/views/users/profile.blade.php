                        ...
                        <div class="pl-0">
                            <div class="main-profile-overview">
                                <div class="main-img-user profile-user">
                                    ...
                                    @else
                                        <img
                                            src="{{ URL::asset('attachments/profile/Admin/' . Auth::user()->id . '/' . Auth::user()->avatar) }}">
                                    @endif
            ...
            <form action='{{ route('addimage.update') }}' method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    @else
                        <input type="file" name="photo" class="dropify"
                            accept=".pdf,.jpg, .png, image/jpeg, image/png"
                            data-default-file="{{ URL::asset('attachments/profile/Admin/' . Auth::user()->id . '/' . Auth::user()->avatar) }}"
                            data-height="100" />
                    @endif
