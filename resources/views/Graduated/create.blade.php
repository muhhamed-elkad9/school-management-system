                ...
                <form action="{{ route('Graduated.store') }}" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            <label for="inputState">{{ __('students/students.Grade') }}</label>
                            <select class="custom-select mr-sm-2" name="Grade_id" required>
                                <option selected disabled>{{ __('students/students.Grade_Choose') }}...</option>
                    ...
                    <button type="submit" class="btn btn-primary">{{ __('students/students.Save') }}</button>
                </form>
