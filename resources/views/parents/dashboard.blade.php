                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <div class="d-flex justify-content-start">
                                                    <span class="mr-2">المرحلة:</span><span>{{ $son->Grades->Name }}</span>
                                                </div>
                                                <div class="d-flex justify-content-start">
                                                    <span class="mr-2">الصف:</span><span>{{ $son->classroom->Name_Class }}</span>
                                                </div>
                                                <div class="d-flex justify-content-start">
                                                    <span class="mr-2">القسم:</span><span>{{ $son->Sections->Name_Section }}</span>
                                                </div>
