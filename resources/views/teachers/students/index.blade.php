...
<form method="post" action="{{ route('attendance') }}" autocomplete="off">
    ...
    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
        ...
        <thead>
            <tr>
                ...
                <th class="alert-success">{{ __('students/students.Email') }}</th>
                <th class="alert-success">{{ __('students/students.Gender') }}</th>
                <th class="alert-success">{{ __('students/students.Grade') }}</th>
                <th class="alert-success">{{ __('students/students.classrooms') }}</th>
    ...
    <P>
        <button class="btn btn-success" type="submit">{{ __('students/students.Save') }}</button>
    </P>
</form><br>
<!-- row closed -->
@endsection
