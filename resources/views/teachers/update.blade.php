                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" name="Gender_id">
                                        <option disabled>{{ __('teachers/teachers.Select_Gender') }}...</option>
                                        @foreach ($Genders as $gender)
                                            <option value="{{ $gender->id }}">{{ $gender->Name }}</option>
                                        @endforeach
                                        <option selected value="{{ $Teachers->id }}">{{ $Teachers->genders->Name }}
                                        </option>
                                    </select>
                                    @error('Gender_id')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <div class="col">
                                    ...
                                    <div class='input-group date'>
                                        <input class="form-control" type="text" id="datepicker-action"
                                            name="Joining_Date" value="{{ $Teachers->Joining_Date }}"
