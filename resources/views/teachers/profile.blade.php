                        ...
                        <div class="pl-0">
                            <div class="main-profile-overview">
                                <div class="main-img-user profile-user">
                                    ...
                                    @else
                                        <img
                                            src="{{ URL::asset('attachments/profile/teacher/' . Auth::user()->id . '/' . Auth::user()->avatar) }}">
                                    @endif
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content border-left border-bottom border-right border-top-0 p-4">
                            <div class="tab-pane active" id="settings">
                                <form action="{{ route('TeachersImage.update', $information->id) }}" method="POST">
                                    {{ csrf_field() }}

                                    <div class="form-group">
                                        <label for="name">اسم المستخدم بالعربية:</label>
                                        <input type="text" name="Name_ar"
                                            value="{{ $information->getTranslation('Name', 'ar') }}"
                                            class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="name">اسم المستخدم بالانجليزية:</label>
...
<div class="modal fade" id="photo_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action='{{ route('TeachersImage.update') }}' method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="modal-body">
                    ...
                    @else
                        <input type="file" name="photo" class="dropify"
                            accept=".pdf,.jpg, .png, image/jpeg, image/png"
                            data-default-file="{{ URL::asset('attachments/profile/teacher/' . Auth::user()->id . '/' . Auth::user()->avatar) }}"
                            data-height="100" />
                    @endif
